...
from hangman_art import logo # Or you can use: from hangman_art import logo, stages
print(logo)
...
while not  end_of_game:
    ...
    if guess not in chosen_word: 
         ...
         print(f"You guessed {guess}, that's not in the chosen_word. You lose a life.")
         lives -=1
         if lives == 0:
              end_of_game = True
              print("you lose")
